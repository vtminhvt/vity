metadata {
definition(name: " VITY ZigBee Switch 1T", namespace: "smartthings", author: "vtminhvt@gmail.com", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings", vid: "generic-switch-power") {
		capability "Actuator"
